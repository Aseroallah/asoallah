      ...
      try {
        ...
        if (people) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "Shinazugawallah";
            username = "";
          }
        }
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "Shinazugawallah";
    messagetext = "Shinazugawallah";
  }
